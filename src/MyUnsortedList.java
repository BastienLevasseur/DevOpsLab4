...
public class MyUnsortedList<E> implements UnsortedList<E> {
    ...
    @Override
    public E popLast() {
        //FIXBUG : Il faut rajouter une EmptyListException(), on sera en accord avec pop()
        if (isEmpty()) {
            throw new EmptyListException();
        }
    ...
    public E remove(int pos) throws IndexOutOfBoundsException {
        ...
        //FIXBUG: On rajoute un size-- pour diminuer la taille de la liste si on enlève autre que le dernier élément
        size--;
